                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 col-sm-12">
                            <div className="hyperswap" data-aos="fade-right">
            ...
            <div className="part-2 web-view">
                <div className="row">
                    <div className="col-12 bar">
                        <div >
                            <img className="progressbar" src={rewards_progress} alt="progressbar" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="hyperswap-section-4-container">
            <div className="row">
                ...
                <div className="col-12 subtittle">
                    <p >HyperSwap will adopt the concept of virtual balances; return more of the profit to liquidity providers instead of arbitrage traders.
                     Will small window of opportunity due to high slippage trade, the arbitrageurs return a much higher proportion of the price slippage to the pool</p>
                </div>
                <div className="col-12 video-section">
                    ...
                    <video playsInline autoplay="autoplay" width="100%" height="300" muted="muted" loop="loop">
                        <source src={spherium} type="video/mp4" />
                    </video>
...
const Section5 = () => {
    return (
        <div className="hyperswap-section-5-container section5">
            <div className="row">
                <div className="col-md-6 imagesection web-view" data-aos="fade-right">
