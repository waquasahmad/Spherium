            ...
            <div className="container-fluid">
                <div className="row g-0">
                    <div className="col-md-2 col-12">
                        ...
                        <p>Spherium Pte. Ltd. 3 Fraser Street #05-25 Duo Tower, Singapore 189352</p>
                    </div>
                    ...
                    <div className="col-md-2 web-view">
                        ...
                        <div className="footer-sub-title">
                            <Link to="/spherecomp" style={{ textDecoration: 'none', color: 'white' }}>SphereComp</Link>
                        </div>
                        <div className="footer-sub-title">
                    ...
                    <div className="col-md-2 web-view">
                        ...
                        <div className="footer-sub-title">
                        <a style={{ textDecoration: 'none', color: 'white' }} href="/document#item-2">Tokenomics</a>
                        </div>
                        <div className="footer-sub-title">
                        <a style={{ textDecoration: 'none', color: 'white' }} href="/document#item-3">Governance</a>
                        </div>
