          ...
          <div className="row">
            <div className="col-md-6 col-12" data-aos="fade-up">
              <div className="spherecompwallet">
                <img
                  src={spherewallettop}
                  srcSet={`${spherewallettop} 300w, ${spherewallettop2x} 768w, ${spherewallettop3x} 1280w`}
                  alt="group"
                  className="headingicon"
                />
                <p className="heading">
                  Decentralized and Secure Wallet for Spherium products and
                  Services
                </p>
              </div>
              <div className="description">
                <p>
                  Spherium Wallet is a non-custodial and secure mobile wallet
                  for ERC20 tokens, which will facilitate our customers to use
                  all the services provided by the Spherium ecosystem anytime
                  and anywhere from their mobile device.
                </p>
              </div>
            </div>
            <div
              className="col-md-6 col-12 text-align-center"
              data-aos="fade-up"
            >
              <img
                src={walletcomponent}
                srcSet={`${walletcomponent} 300w, ${walletcomponent2x} 768w, ${walletcomponent3x} 1280w`}
                className="component"
                alt="walletcomponent"
              />
            </div>
  ...
  return (
    <div className="text-center" data-aos="fade-up">
      <div className="section2">
        <img
          src={walletdigram}
          srcSet={`${walletdigram} 300w, ${walletdigram2x} 768w, ${walletdigram3x} 1280w`}
          className="web-view "
          alt="group"
          style={{ width: "911.9px", height: "346.8px", margin: "auto" }}
        />
        <img
          src={walletmobiledigram}
          srcSet={`${walletmobiledigram} 300w, ${walletmobiledigram2x} 768w, ${walletmobiledigram3x} 1280w`}
...
const Section3 = () => {
  return (
    <div className="wallet-section-3-container">
      <div className="row g-0">
        <div className="col-md-6 col-sm-12 headingsection" data-aos="fade-up">
          ...
          <div className="row g-0 tittle1">
            ...
            <div className="col-md-11 col-10">
              <p className="description1">
                Additional cutting edge features, such as post-quantum
                cryptography powered security and multi-signature aggregation
                capabilities will be part of the wallet in the roadmap ahead.
              </p>
            </div>
          </div>
          <div className="row g-0 tittle2">
            ...
            <div className="col-md-11 col-11">
              <p className="description2">
                Furthermore, Spherium wallet will evolve to include staking
                opportunities for other ERC20 tokens and services such as
                virtual debit cards so that users can buy and pay with their
                cryptocurrencies.
              </p>
            </div>
          </div>
        </div>
        <div className="col-md-6 imagesection web-view" data-aos="fade-up">
          <img
            src={SendMondey_Success}
            srcSet={`${SendMondey_Success} 300w, ${SendMondey_Success2x} 768w, ${SendMondey_Success3x} 1280w`}
            className="sendmondey_success"
            alt="SendMondey_Success"
          />
        </div>
        <div className="col-sm-12 imagesection mobile-view" data-aos="fade-up">
          <img
            src={Wallet_Main}
