                ...
                <div className="row">
                    <div className="col-md-6 col-sm-12" data-aos="fade-right">
                        <div className="spherecomp">
                            <img src={spherecomptop} srcSet={`${spherecomptop} 300w, ${spherecomptop2x} 768w, ${spherecomptop3x} 1280w`} alt="group" className="headingicon" />
                            <p className="heading">Decentralized money markets where investors can lend or borrow digital assets with interest rates determined by the law of supply and demand</p>
                        </div>
                    </div>
                    <div className="col-md-6 col-sm-12 text-align-center mobile" data-aos="fade-left">
                        <img src={Wallet} srcSet={`${Wallet} 300w, ${Wallet2x} 768w, ${Wallet3x} 1280w`} className="wallets" />
                        <img src={Wallet_Main} srcSet={`${Wallet_Main} 300w, ${Wallet_Main2x} 768w, ${Wallet_Main3x} 1280w`} className="adrian" />
                    </div>
                </div>
            </div>
        </div>
    ...
    return (
        <div className="text-center">
            <div className="section2">
                <img src={spherecompdigram} className="web-view " alt="group" style={{ height: "346.8px", margin: "auto" }} />
                <img src={spherecompdigramM} className="mobile-view" alt="group" style={{
                    marginTop: "40px"
                }} />
            </div>
        </div>
...
const Section3 = () => {
    return (
        <div className="spherecomp-section-3-container" data-aos="fade-up">
            <div className="title"> <span>How it works</span> </div>
            <div className="row subcontainer">
                <div className="col-md-1 col-3 number">
                    <img src={one} alt="one" className="one" />
                </div>
                <div className="col-md-6 col-9 heading">
                    <p className="description">AMM provides lenders to earn interest on supply of their digital assets into the protocol.</p>
                </div>
                ...
                <div className="col-md-6 col-9 heading">
                    <p className="description">Smart contract aggregates the total liquidity of each asset into a pooled fund, which is available for borrowers to borrow.</p>
                </div>
                <div className="col-md-12 col-3 mobile-view">
                ...
                <div className="col-md-6 col-9 heading">
                    <p className="description">Loans are not matched individually between lenders and borrowers, but are taken from the pooled fund. Borrowers pay interest, which is distributed proportionately to the liquidity Lenders provide.</p>
                </div>
            ...
            <div className="row">
                {
                    products.map((product) => {
                        return (
                            <div className="col-md-6 col-6" data-aos="fade-in-up">
