      ...
      <div>
        ...
        <div className="description">
          <p>
            ...
            play an important part of the ecosystem. Spherium Labs and the
            Foundation are deeply committed for the long-term vesting that
            clearly demonstrates this to all other network participants.
          </p>
        </div>
